...
CACHE_PATH       = os.path.join(os.path.dirname(__file__), '..', 'cache', 'sede_table_v3.npz')
CACHE_PATH_LCDM  = os.path.join(os.path.dirname(__file__), '..', 'cache', 'lcdm_table_v1.npz')
CACHE_PATH_SEDEH = os.path.join(os.path.dirname(__file__), '..', 'cache', 'sedeH_table_v1.npz')
CACHE_PATH_SEDEH_RUN = os.path.join(os.path.dirname(__file__), '..', 'cache', 'sedeH_run_table_v1.npz')

_CACHE_BY_MODEL = {'sede': CACHE_PATH, 'lcdm': CACHE_PATH_LCDM, 'sedeH': CACHE_PATH_SEDEH}
