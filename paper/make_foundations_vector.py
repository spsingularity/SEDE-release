...
build_foundations.sh then points \\includegraphics at the .pdf, so xelatex embeds
the vector versions.
...
SCRIPTS = [
    "paper/make_foundations_figures.py",   # fig1_reduction, fig4_socsignature, fig5_inferences
    "experiments/run_chr_soc.py",          # criticality_soc (Fig 2)
    "experiments/run_deposition_drive.py", # deposition_drive (Fig 3)
]
...
print("\nDone. Vector PDFs written next to the PNGs in output/.")
