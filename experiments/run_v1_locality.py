"""
run_v1_locality.py — the strong defence of V1 (the referee's circularity charge).

V1 (Referee A): "count⟸connectivity⟸range is circular: 'gravity long-range ⟹ horizon
...
print("""  THE CHARGE: 'gravity long-range ⟹ horizon dof all-to-all entangled' assumes
  ...
  (2) AREA IS NOT THE DEFAULT. The referee's implicit 'area-law is the natural
