...
background (sede.friedmann.E_SEDE_H); this is justified by the paper's own result that
...
def sede_cpl(Om, gamma=1.5, zmax=3.0, n=300):
    ...
    energy actually matters. NOT E_SEDE_H (that is the λ=1 cousin, w0≈−0.86)."""
