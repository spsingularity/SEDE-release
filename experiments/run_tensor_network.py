...
Output: console, results/tensor_network.json, output/fig_tensor_network.png.
"""
import json
import os
import numpy as np
...
def _figure(r):
    ...
    fig.savefig("output/fig_tensor_network.png", dpi=130)
    plt.close(fig)
    print("wrote output/fig_tensor_network.png")
