...
Output: console summary, results/syk_scrambling.json, output/fig_syk_scrambling.png.
"""
import json
import os
import numpy as np
...
def _make_figure(gap, page, ts, C4, C2):
    ...
    fig.savefig("output/fig_syk_scrambling.png", dpi=130)
    plt.close(fig)
    print("wrote output/fig_syk_scrambling.png")
