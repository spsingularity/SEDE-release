...
Output: console summary, results/causal_set.json, output/fig_causal_set.png.
"""
import json
import os
import numpy as np
...
def _make_figure(r):
    ...
    fig.savefig("output/fig_causal_set.png", dpi=130)
    plt.close(fig)
    print("wrote output/fig_causal_set.png")
