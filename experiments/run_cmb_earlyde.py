#!/usr/bin/env python3
"""
Fig 9 — Why SEDE survives the CMB where standard holographic DE dies  [referee R3, the ★★★★★ threat]
====================================================================================================
...
This figure shows that argument directly:
  Panel A — the early-DE fraction Ω_DE(z): SEDE dips BELOW ΛCDM at high z (gate f_sat→0), while
            un-gated standard Barrow-HDE carries MORE early DE; at z=3, SEDE 0.029 < ΛCDM 0.040.
...
def main():
    ...
    plt.tight_layout(); plt.savefig('output/fig_cmb_earlyde.png', dpi=130)
    print("  saved -> output/fig_cmb_earlyde.png")
