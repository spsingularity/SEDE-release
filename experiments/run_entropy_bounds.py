...
the fractal-horizon reinterpretation. Output: console, results/entropy_bounds.json, output/fig_entropy_bounds.png.
...
def _figure(a):
    ...
    fig.savefig("output/fig_entropy_bounds.png", dpi=130)
    plt.close(fig)
    print("wrote output/fig_entropy_bounds.png")
